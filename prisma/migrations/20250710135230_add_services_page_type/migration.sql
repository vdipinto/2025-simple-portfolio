/*
  ...
  - The values [BLOG,CONTACT] on the enum `PageType` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "PageType_new" AS ENUM ('GENERAL', 'SERVICES');
...
ALTER TABLE "Page" ALTER COLUMN "type" SET DEFAULT 'GENERAL';
COMMIT;
