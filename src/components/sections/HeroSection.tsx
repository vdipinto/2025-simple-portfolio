...
const HeroSection = () => {
  return (
    <section className="relative isolate overflow-hidden bg-background text-foreground h-[80vh]">
      ...
      {/* Soft bokeh blobs */}
      <div aria-hidden="true" className="pointer-events-none absolute inset-0 blur-3xl -z-10">
      ...
      {/* Content */}
      <div className="relative z-10 mx-auto max-w-5xl px-6 py-28 sm:py-36 lg:py-44">
